...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ConfWidget.routeName,
          path: ConfWidget.routePath,
          builder: (context, params) => ConfWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'noticias')
              : NoticiasWidget(),
        ),
        FFRoute(
          name: CadastroDOCWidget.routeName,
          path: CadastroDOCWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'cadastroDOC')
              : CadastroDOCWidget(),
        ),
        FFRoute(
          name: PageDocumentoWidget.routeName,
          path: PageDocumentoWidget.routePath,
        ...
        FFRoute(
          name: AddDocumentoWidget.routeName,
          path: AddDocumentoWidget.routePath,
