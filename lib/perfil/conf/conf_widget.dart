...
import 'conf_model.dart';
export 'conf_model.dart';

class ConfWidget extends StatefulWidget {
  const ConfWidget({super.key});

  static String routeName = 'conf';
  static String routePath = '/conf';
...
class _ConfWidgetState extends State<ConfWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfModel());
  }
